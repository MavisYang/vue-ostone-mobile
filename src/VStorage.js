...
export default {
  install: function (Vue, options) {
    ...
    var localStorage = _storageProvider('localStorage')
    var sessionStorage = _storageProvider('sessionStorage')
    var storage = {}
    ...
    function _storageProvider (storageType) {
      ...
      var _webStorage = isStorageSupported(window, storageType)
      // 浏览器的存储对象(localStorage/sessionStorage)
