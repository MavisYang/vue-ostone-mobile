  ...
  <div class="personal">
    <validator name="validation1">
      <div class="ipt-box">
        ...
        <input type="text" v-model="userMobile" class="form-control" v-validate:message="{ required: true }" placeholder="请输入手机号"><br />
      </div>
      <div class="ipt-box">
        <i class="icon iconfont">&#xe612;</i>
...
export default {
  ...
  methods: {
    ...
    login: function () {
      // this.hasClick = true
      var me = this
      api.login(this.userMobile, this.password, 0, function (result) {
        console.log(result)
        if (result.sucess) {
          me.loginOk = true
